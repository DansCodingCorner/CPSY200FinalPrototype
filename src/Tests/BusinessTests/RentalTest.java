...
class RentalTest {
	...
	void testRentalCreation() {
		Rental rental = new Rental(1, LocalDate.now(), 1, 1, LocalDate.now(), LocalDate.now().plusDays(7), 100.0, false);
	...
	void testRentalSetters() {
		Rental rental = new Rental(2, LocalDate.now(), 2, 2, LocalDate.now(), LocalDate.now().plusDays(7), 150.0, false);
	...
	void testRentalDateHandling() {
		Rental rental = new Rental(3, LocalDate.now(), 3, 3, LocalDate.now(), LocalDate.now().plusDays(7), 200.0, false);
	...
	void testRentalIdHandling() {
		Rental rental = new Rental(4, LocalDate.now(), 4, 4, LocalDate.now(), LocalDate.now().plusDays(7), 250.0, false);
	...
	void testRentalCustomerAndEquipmentIdHandling() {
		Rental rental = new Rental(6, LocalDate.now(), 5, 6, LocalDate.now(), LocalDate.now().plusDays(7), 300.0, false);
	...
	void testRentalCostHandling() {
		Rental rental = new Rental(8, LocalDate.now(), 6, 7, LocalDate.now(), LocalDate.now().plusDays(7), 350.0, false);
	...
	void testRentalDateSetters() {
		Rental rental = new Rental(9, LocalDate.now(), 7, 8, LocalDate.now(), LocalDate.now().plusDays(7), 450.0, false);
	...
	void testRentalToString() {
		Rental rental = new Rental(10, LocalDate.now(), 8, 9, LocalDate.now(), LocalDate.now().plusDays(7), 500.0, false);
	...
	void testRentalWithInvalidData() {
		assertThrows(IllegalArgumentException.class, () -> {
			new Rental(-1, LocalDate.now(), -1, -1, LocalDate.now(), LocalDate.now().plusDays(7), -100.0, false);
		});
	}
	...
	void testRentalWithNullDates() {
		assertThrows(NullPointerException.class, () -> {
			new Rental(11, null, 9, 10, null, null, 550.0, false);
		});
	}

	@Test
	void testRentalWithInvalidDateFormat() {
		Rental rental = new Rental(12, LocalDate.now(), 10, 11, LocalDate.now(), LocalDate.now().plusDays(7), 600.0, false);
