...
class RentalDataAccessTest {
	...
	void testLoadRentals() {
		IRental rental1 = new Rental(1, LocalDate.of(2024,2,13), 1, 1, LocalDate.parse("2024-01-01"), LocalDate.parse("2024-01-10"), 100.0, false);
		IRental rental2 = new Rental(2, LocalDate.of(2024,2,14), 2, 2, LocalDate.parse("2024-02-01"), LocalDate.parse("2024-02-10"), 150.0, false);
